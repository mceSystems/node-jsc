...
String16 String16::fromInteger(int number) {
  return WTF::numberToStringSigned<String16>(number);
}
...
String16 String16::fromDouble(double number) {
  ...
  return String16(WTF::numberToString(number, buffer));
}

// static
String16 String16::fromDouble(double number, int precision) {
  NumberToStringBuffer buffer;
  return String16(WTF::numberToFixedWidthString(number, precision, buffer));
}
